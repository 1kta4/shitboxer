    ...
    public class McpUnityServer : IDisposable
    {
        ...
        private StartServerResult StartServerInternal(bool logAddressInUseAsError)
        {
            ...
            try
            {
                ...
                var host = McpUnitySettings.Instance.AllowRemoteConnections ? "0.0.0.0" : "127.0.0.1"; // was "localhost": resolves to ::1 on Windows, unreachable from WSL mirrored networking
