...
namespace Shitboxer.Tests
{
    ...
    public class RaceHudFormatTests : TestBase
    {
        ...
        public void ProjectedPaceExcess_BeforeTheGateDistance_IsOmitted()
        {
            ...
            Assert.AreEqual(-1f, RaceHud.ProjectedPaceExcess01(400f, 300f, Lap));
        }
        ...
        public void ProjectedPaceExcess_LeaderUnderGate_IsOmitted()
        {
            ...
            Assert.AreEqual(-1f, RaceHud.ProjectedPaceExcess01(650f, 640f, Lap));
        }
        ...
        public void ProjectedPaceExcess_PlayerIsTheLeader_IsZero()
        {
            ...
            Assert.AreEqual(0f, RaceHud.ProjectedPaceExcess01(1400f, 1400f, Lap), 1e-4f);
        }
        ...
        public void ProjectedPaceExcess_IsTheDistanceRatio_NotTheDistanceGap()
        {
            ...
            Assert.AreEqual(0.5f, RaceHud.ProjectedPaceExcess01(1500f, 1000f, Lap), 1e-4f);
        }

        [Test]
        public void FormatCutoffPace_OmittedSentinel_IsEmpty()
        {
            Assert.AreEqual(string.Empty, RaceHud.FormatCutoffPace(-1f, 0.15f));
        }

        [Test]
        public void FormatCutoffPace_InsideTheGate_ReadsSafe()
        {
            Assert.AreEqual("PACE +8%  /  CUT +15%   SAFE", RaceHud.FormatCutoffPace(0.08f, 0.15f));
        }

        [Test]
        public void FormatCutoffPace_OutsideTheGate_ReadsAtRisk()
        {
            Assert.AreEqual("PACE +19%  /  CUT +15%   AT RISK", RaceHud.FormatCutoffPace(0.19f, 0.15f));
        }
        ...
        public void FormatCutoffPace_ExactlyOnTheGate_StillReadsSafe()
        {
            ...
            Assert.AreEqual("PACE +15%  /  CUT +15%   SAFE", RaceHud.FormatCutoffPace(0.15f, 0.15f));
        }
        ...
        public void FormatPayoutPreview_MidfieldShowsTheInversion()
        {
            ...
            Assert.AreEqual("BANKING $10 at P6   (WIN PAYS $7)", RaceHud.FormatPayoutPreview(6, 10, 7));
        }
        ...
        public void FormatPayoutPreview_LeadingDropsTheRedundantComparison()
        {
            ...
            Assert.AreEqual("BANKING $7 — LEADING", RaceHud.FormatPayoutPreview(1, 7, 7));
        }
    }
}
